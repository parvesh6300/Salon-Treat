...
public class LocationActivity extends AppCompatActivity {
    ...
    LocationService ls = LocationService.getLocationManager(LocationActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleLocation sl = new SimpleLocation(LocationActivity.this);

        // if we can't access the location yet
        if (!sl.hasLocationEnabled()) {
            // ask the user to enable location access
            SimpleLocation.openSettings(LocationActivity.this);
        }
        ...
        String l = "lat "+ sl.getLatitude()+" long " + sl.getLongitude();
        infoText.setText("fg " + l);
    }
    ...
    public void onButtonClicked(View view) {
        ...
        name = addressEdit.getText().toString();
