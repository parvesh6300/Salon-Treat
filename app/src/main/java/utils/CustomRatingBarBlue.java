...
public class CustomRatingBarBlue extends LinearLayout {
    ...
    private int mStarOffResource = R.drawable.bluestarfade;
    private int mStarHalfResource = R.drawable.halfstarblue;
    ...
    public CustomRatingBarBlue(Context context) {
        super(context);
    ...
    public CustomRatingBarBlue(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomRatingBarBlue(Context context, AttributeSet attrs, int defStyle) {
