...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.starselected;
    private int mStarOffResource = R.drawable.starnoteselected;
    private int mStarHalfResource = R.drawable.halfstar;
    ...
    public CustomRatingBar(Context context,int mStarOffResource,int mStarOnResource ) {
        super(context);

        setmStarOffResource(mStarOffResource);
        setmStarOnResource(mStarOnResource);
    ...
    public void setmStarOnResource(int mStarOnResource) {
        this.mStarOnResource = mStarOnResource;
    }

    public void setmStarOffResource(int mStarOffResource) {
        this.mStarOffResource = mStarOffResource;
    }

    public int getmStarOnResource() {
        return mStarOnResource;
    }

    public int getmStarOffResource() {
        return mStarOffResource;
    }
}