...
public class CustomRatingBarWhite extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.starwhite;
    private int mStarOffResource = R.drawable.starwhiteunselected;
    private int mStarHalfResource = R.drawable.halfstarwhite;
    private ImageView[] mStarsViews;
    private float mStarPadding;
    private IRatingBarCallbacks onScoreChanged;
    private int mLastStarId;
    private boolean mOnlyForDisplay = true;
    private double mLastX;
    private boolean mHalfStars = true;

    public CustomRatingBarWhite(Context context) {
        super(context);
    ...
    public CustomRatingBarWhite(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomRatingBarWhite(Context context, AttributeSet attrs, int defStyle) {
